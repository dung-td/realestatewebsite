                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6">
                                    <form action="" className="space-y-4">
                                        <div className="relative flex w-full flex-wrap items-stretch md-3">
                                            ...
                                            <input className="px-3 py-3 placeholder-slate-400 text-slate-600 relative bg-white rounded text-sm border border-inherit outline-none focus:outline-none focus:border-black w-full pl-10" type="text" placeholder="Tên đăng nhập/Email" name="accountname/email" required></input>
                                        </div>
                                        <span className="z-10 h-full leading-snug font-normal absolute text-center text-slate-600 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <input className="px-3 py-3 placeholder-slate-400 text-slate-600 relative bg-white rounded text-sm border border-inherit outline-none focus:outline-none focus:border-black w-full pl-10" type={showPassword ? "text" : "password"} placeholder="Mật khẩu" name="password" required></input>
                                        <span onClick={isShowPassword}
                                            ...
                                            {showPassword ? <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                            </svg> :
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        ...
                                        <button className="w-full h-12 rounded bg-red-600 text-white" type="submit">Đăng nhập</button>
                                        <div className="flex justify-between">
                                            <div className="flex space-x-2">
                                                <input className="w-4 h-4 mt-1" type="checkbox"></input>
                                                <p>Nhớ tài khoản</p>
                                            </div>
                                            <a href="#" className="text-red-500">Quên mật khẩu</a>
                                        </div>
                                ...
                                <div className="w-full flex justify-center p-6 space-x-2">
                                    <div className="w-auto relative">
                                        <button className="flex w-full rounded h-14 border border-inherit">
                                            <span className="pt-2 w-12 h-12 leading-snug font-normal absolute bg-transparent rounded text-base w-8 pl-3">
                                                <Image src="/834722_facebook_icon.svg" width="100" height="100" />
                                            </span>
                                            <p className="self-center pl-16 pr-10">
                                                FaceBook
                                            </p>
                                        </button>
                                    </div>
                                    <div className="w-auto relative">
                                        <button className="flex w-full rounded h-14 border border-inherit">
                                            <span className="pt-2 w-12 h-12 leading-snug font-normal absolute bg-transparent rounded text-base w-8 pl-3">
                                                <Image src="/2993685_brand_brands_google_logo_logos_icon.svg" width="100" height="100" />
                                            </span>
                                            <p className="self-center pl-16 pr-10">Google</p>
                                        </button>
                                    </div>
                                </div>
                                <p className="p-6 text-center">Chưa là thành viên? <span className="text-red-500 cursor-pointer">Đăng ký</span> tại đây</p>
                            </div>
                        </div>
                    </div>
