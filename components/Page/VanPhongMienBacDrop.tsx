    ...
    return (
        <div className="flex space-x-4 pt-6">
            <div className="space-y-4">
                ...
                {/* {OfficeCard("Văn phòng đại diện Thái Bình", "Đường Đê Bờ Sông Trà Lý, Tổ 7 Hoàng Diệu, TP.Thái Bình", "0968 592 468")}
                {OfficeCard("Văn phòng đại diện Hòa Bình", "Số Nhà 446, Tiểu Khu 6, Thị Trấn Lương Sơn, Tỉnh Hòa Bình", "0963.932.368")}
                {OfficeCard("Văn phòng đại diện Hải Dương", "Số 118 Thanh Bình, P. Thanh Bình, TP. Hải Dương", "0936.707.379")}
                {OfficeCard("Văn phòng đại diện Sơn Tây", "Số 54, tổ dân phố 2, đường Trung Sơn Trầm, Thị xã Sơn Tây, Hà Nội", "0977.098.666")}
                {OfficeCard("Văn phòng đại diện Bắc Giang","Trung tâm VHTT người cao tuổi Tỉnh Bắc Giang, Đường Lý Tự Trọng, P. Xương Giang, TP. Bắc Giang", "0987.290.969")}
                {OfficeCard("Văn phòng đại diện Phú Thọ", "Số 02, Ngõ 06 Đường Hùng Quốc Vương, Khu tái định cư Đồng Gia, P. Minh Nông, TP. Việt Trì, Tỉnh Phú Thọ", "0983.374.185")} */}
            </div>
            <div className="space-y-4">
                ...
                {/* {OfficeCard("Văn phòng đại diện Hải Phòng", "Số nhà 569 Đường 208 An Đồng, An Dương, Hải Phòng", "0976 316 929")}
                {OfficeCard("Văn phòng đại diện Bắc Ninh", "Lô 13 Tòa thương mại Cát Tường ECO - Đường Lê Thái Tổ - P. Võ Cường - TP.Bắc Ninh", "0985.156.668")}
                {OfficeCard("Văn phòng đại diện Hưng Yên", "Số 97 Phạm Ngũ Lão, Ân Thi, Hưng Yên", "0357.351.888")}
                {OfficeCard("Văn phòng đại diện Nam Định", "Nhà Hàng Mai Anh, Tổ 18 Thị Trấn Xuân Trường, Nam Định", "0913.769.339")}
                {OfficeCard("Văn phòng đại diện Vĩnh Phúc", "Số 2, Lô 3, Khu đô thị Chùa Hà Tiên, TP. Vĩnh Yên, Tỉnh Vĩnh Phúc", "0966.833.908")} */}
            </div>
        </div>
    )
}
