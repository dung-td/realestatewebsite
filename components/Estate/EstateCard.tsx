...
const EstateCard = (props : Props) => {
    ...
    return (
        <Link href={`/${purpose}-${estateSlug}/${postSlug}`} passHref={true}>
            <a className={`group flex flex-row xl:flex-row h-max min-h-[264px] drop-shadow-md border-solid border border-gray-200 rounded-lg cursor-pointer hover:border-gray-400 ${props.style}`}>
