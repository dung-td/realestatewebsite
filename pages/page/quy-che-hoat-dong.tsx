...
const QuyCheHoatDong = () => {
    ...
    return <div className="pl-36 space-y-5 h-screen bg-gray-100">
        <div className="flex">
            ...
            <h3 className="cursor-pointer">Quy chế hoạt động</h3>
        </div>
        <div className="flex">
        <div className="flex">
            <div className="space-y-3">
                <h3 className="p-4 border-l-4 border-indigo-500">Công ty</h3>
                <ul className="text-sm font-medium text-gray-500">
                    ...
                    <li className="mr-2">
                        <Link href={"./quy-che-hoat-dong"}>
                            <a id="tab1" className="inline-block p-4 text-white bg-indigo-500 rounded-lg active dark:bg-gray-800 dark:text-blue-500 w-56 cursor-pointer">Quy chế hoạt động</a>
                        </Link>
                    </li>
                    <li className="mr-2">
                ...
                <ul className="text-sm font-medium text-gray-500">
                    ...
                    <li className="mr-2">
                        <Link href={"./tro-giup"}>
                            <a id="tab6" className="inline-block p-4 text-gray-600 bg-gray-100 rounded-lg active dark:bg-gray-800 dark:text-blue-500 w-56 cursor-pointer">Trợ giúp</a>
                        </Link>
                    </li>
                </ul>
            </div>
