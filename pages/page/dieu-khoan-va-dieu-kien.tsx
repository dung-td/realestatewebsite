...
const DieuKhoanVaDieuKien = () => {
    ...
    return <div className="pl-36 space-y-5 h-screen bg-gray-100">
        <div className="flex">
            ...
            <h3 className="cursor-pointer">Điều khoản và dịch vụ</h3>
        </div>
        <div className="flex">
        <div className="flex">
                ...
                <ul className="text-sm font-medium text-gray-500">
                    ...
                    <li className="mr-2">
                        <Link href="./dieu-khoan-va-dieu-kien">
                            <a id="tab3" className="inline-block p-4 text-white bg-indigo-500 rounded-lg active dark:bg-gray-800 dark:text-blue-500 w-56 cursor-pointer">Điều khoản và điều kiện</a>
                        </Link>
                    </li>
                </ul>
