...
const LienHe = () => {
    ...
    return <div className="pl-36 space-y-5 h-screen bg-gray-100">
        <div className="flex">
            ...
            <h3 className="cursor-pointer">Liên hệ</h3>
        </div>
        <div className="flex">
            <div className="flex">
                <div className="space-y-3">
                    ...
                    <ul className="text-sm font-medium text-gray-500">
                        ...
                        <li className="mr-2">
                            <Link href={"./lien-he"}>
                                <a id="tab5" className="inline-block p-4 text-white bg-indigo-500 rounded-lg active dark:bg-gray-800 dark:text-blue-500 w-56 cursor-pointer">Liên hệ</a>
                            </Link>
                        </li>
                        <li className="mr-2">
                            <Link href={"./tro-giup"}>
